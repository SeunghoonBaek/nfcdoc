#include <new>
#include "TizenAppApp.h"
#include "TizenAppFrame.h"

using namespace Tizen::App;
using namespace Tizen::System;

TizenAppApp::TizenAppApp(void)
{
}
...
UiApp*
TizenAppApp::CreateInstance(void)
{
	// TODO: Create the application instance through the constructor.
	return new (std::nothrow) TizenAppApp();
}

bool
TizenAppApp::OnAppInitializing(AppRegistry& appRegistry)
{
...
bool
TizenAppApp::OnAppInitialized(void)
{
	// TODO: Create the application frame.

	TizenAppFrame* pTizenAppFrame = new (std::nothrow) TizenAppFrame;
	TryReturn(pTizenAppFrame != null, false, "The memory is insufficient.");
	pTizenAppFrame->Construct();
	pTizenAppFrame->SetName(L"TizenApp");
	AddFrame(*pTizenAppFrame);

	return true;
}

bool
TizenAppApp::OnAppWillTerminate(void)
{
...
bool
TizenAppApp::OnAppTerminating(AppRegistry& appRegistry, bool forcedTermination)
{
